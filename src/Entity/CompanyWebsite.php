...
/**
 * @ORM\Table(name="companies_websites")
 * @ORM\Entity(repositoryClass="App\Repository\CompanyWebsiteRepository")
 */
class CompanyWebsite
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Company", inversedBy="website")
