...
/**
 * @ORM\Table(name="companies_images")
 * @ORM\Entity(repositoryClass="App\Repository\CompanyImagesRepository")
 */
class CompanyImages
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Company", inversedBy="image")
